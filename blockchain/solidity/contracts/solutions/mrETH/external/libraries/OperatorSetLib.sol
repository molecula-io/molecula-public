 ...
 * https://github.com/Layr-Labs/eigenlayer-contracts/blob/main/src/contracts/libraries/OperatorSetLib.sol
 */
...
/**
 * @notice Operator set identified by the AVS address and an identifier.
 * @param avs Address of the AVS this operator set belongs to.
 * @param id Operator set's ID.
 */
struct OperatorSet {
    address avs;
    uint32 id;
