...
import {UnsuppliedWrappedRebaseAsset} from "./UnsuppliedWrappedRebaseAsset.sol";
...
contract MoleculaUnsuppliedWrapper is UnsuppliedWrappedRebaseAsset, VoteToken {
    ...
    /// @param bridger_ Address authorized to mint and burn tokens during the `unsupplied` state. Maybe be the zero address.
    constructor(
        string memory name,
        ...
        UnsuppliedWrappedRebaseAsset(bridger)
    {}
